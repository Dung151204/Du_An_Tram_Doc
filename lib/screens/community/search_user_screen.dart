      ...
      body: _searchQuery.isEmpty
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(
              child: Column(
                ...
                children: [
                  const Icon(LucideIcons.frown, size: 60, color: Colors.grey),
          ...
          if (filteredUsers.isEmpty) {
            return const Center(child: Text("Không tìm thấy ai khác ngoài bạn"));
          }
              ...
              return Container(
                ...
                child: ListTile(
                  leading: CircleAvatar(
                    ...
                    child: Text(initial, style: const TextStyle(color: Colors.blueAccent, fontWeight: FontWeight.bold)),
                  ),
    ...
    return StreamBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        return ElevatedButton(
          ...
          child: Text(isFollowing ? "Đã theo dõi" : "Theo dõi", style: const TextStyle(fontWeight: FontWeight.bold)),
        );
      },
    );
  }
