    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text("Lỗi đăng xuất: $e"), backgroundColor: Colors.red),
        );
      }
    }
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return AppBar(
      ...
      automaticallyImplyLeading:
          false, // [QUAN TRỌNG] Đảm bảo không hiện nút back tự động
      ...
      builder: (context, userSnapshot) {
        ...
        return StreamBuilder<List<BookModel>>(
          ...
          builder: (context, bookSnapshot) {
            ...
            int totalNotes =
                books.fold(0, (sum, book) => sum + book.keyTakeaways.length);
              ...
              return Container(
                ...
                child: const Column(
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text("Bạn chưa theo dõi ai cả.",
                        style: TextStyle(color: Colors.grey)),
                    Text("Bấm icon góc trên để tìm bạn bè!",
                        style: TextStyle(color: Colors.blue, fontSize: 12)),
                  ],
                ),
              );
              ...
              itemBuilder: (context, index) {
                ...
                return FutureBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, userSnapshot) {
                    ...
                    String initials = friendName.isNotEmpty
